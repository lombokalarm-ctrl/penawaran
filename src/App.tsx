  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 font-sans text-white">
        <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-xl p-8 shadow-2xl space-y-8">
          ...
          <div className="space-y-4">
            <div className="text-sm text-slate-300 text-center leading-relaxed">
              Selamat datang di Portal Administrasi Penawaran &amp; Invoice. Silakan masuk menggunakan akun Google Anda untuk mengakses data secara aman.
            </div>
